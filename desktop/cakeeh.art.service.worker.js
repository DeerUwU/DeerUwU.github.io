...
/** @type {string} */
const CACHE_VERSION = '1730067808|25810703787';
/** @type {string} */
const CACHE_PREFIX = 'Deer's Desktop-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'cakeeh.art.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["cakeeh.art.html","cakeeh.art.js","cakeeh.art.offline.html","cakeeh.art.icon.png","cakeeh.art.apple-touch-icon.png","cakeeh.art.worker.js","cakeeh.art.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["cakeeh.art.wasm","cakeeh.art.pck"];
